---
title: "simulation 1 msqrobPTM analysis"
...
knitr::opts_knit$set(root.dir = "C:/Users/Nina/OneDrive - UGent/Documenten/Doctoraat/msqrobPTM/Datasets MSStats/simulation_data/")
```
...
```{r}
save(results, file = "results_simulation1_msqrob_comparison1.rda")
save(sign_table, file = "signtable_simulation1_msqrob_comparison1.rda")
```

```{r}
write.csv2(results, file = "results_simulation1_msqrob_comparison1.csv", sep = ";")
```
...
```{r}
save(results, "results_simulation1_msqrob_comparison2.rda")
save(sign_table, file = "signtable_simulation1_msqrob_comparison2.rda")
```
...
```{r}
save(results, file = "results_simulation1_msqrob_comparison3.rda")
save(sign_table, file = "signtable_simulation1_msqrob_comparison3.rda")
```
