---
title: "simulation 2 msqrobPTM analysis"
...
#function adapted from https://github.com/devonjkohler/MSstatsPTM_simulations/blob/main/vignette/MSstatsPTM_Simulation_Analysis.Rmd
...
```{r}
save(results, file = "results_simulation2_msqrob_comparison1.rda")
save(sign_table, file = "signtable_simulation2_msqrob_comparison1.rda")
```

```{r}
write.csv2(results, file = "results_simulation2_msqrob_comparison1.csv", sep = ";")
```
...
```{r}
save(results, "results_simulation2_msqrob_comparison2.rda")
save(sign_table, file = "signtable_simulation2_msqrob_comparison2.rda")
```
...
```{r}
save(results, file = "results_simulation2_msqrob_comparison3.rda")
save(sign_table, file = "signtable_simulation2_msqrob_comparison3.rda")
```
